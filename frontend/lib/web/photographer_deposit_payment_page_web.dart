...
import '../services/photographer_payment_service.dart';

class PhotographerDepositPaymentPageWeb extends StatefulWidget {
  final Map booking;

  const PhotographerDepositPaymentPageWeb({super.key, required this.booking});

  @override
  State<PhotographerDepositPaymentPageWeb> createState() =>
      _PhotographerDepositPaymentPageWebState();
}

class _PhotographerDepositPaymentPageWebState
    extends State<PhotographerDepositPaymentPageWeb> {
  ...
  double get depositAmount =>
      double.tryParse(widget.booking["deposit_amount"]?.toString() ?? "0") ??
      (totalPrice * 0.3);
  ...
  Future<void> startPayment() async {
    ...
    try {
      final data = await PhotographerPaymentService.createPaymentIntent(
        widget.booking["id"],
      );
      ...
      await Stripe.instance.initPaymentSheet(
        paymentSheetParameters: SetupPaymentSheetParameters(
          ...
          merchantDisplayName: "Lensia Photographers",
      ...
      final result = await PhotographerPaymentService.confirmPayment(
        widget.booking["id"],
        paymentIntentId,
      );
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              "Photographer deposit of \$${depositAmount.toStringAsFixed(0)} paid successfully.",
