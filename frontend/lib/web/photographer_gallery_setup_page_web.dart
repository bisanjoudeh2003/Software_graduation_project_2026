...
class PhotographerGallerySetupPageWeb extends StatefulWidget {
  final int bookingId;
  ...
  const PhotographerGallerySetupPageWeb({
    super.key,
  ...
  @override
  State<PhotographerGallerySetupPageWeb> createState() =>
      _PhotographerGallerySetupPageWebState();
}

class _PhotographerGallerySetupPageWebState
    extends State<PhotographerGallerySetupPageWeb> {
