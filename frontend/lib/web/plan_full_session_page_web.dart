...
import 'plan_full_session_results_page_web.dart';

class PlanFullSessionPageWeb extends StatefulWidget {
  const PlanFullSessionPageWeb({super.key});

  @override
  State<PlanFullSessionPageWeb> createState() => _PlanFullSessionPageWebWebState();
}

class _PlanFullSessionPageWebWebState extends State<PlanFullSessionPageWeb> {
  ...
  void _continueToResults() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => PlanFullSessionResultsPageWeb(
