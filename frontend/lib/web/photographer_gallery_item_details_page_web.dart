...
import 'photographer_revision_workspace_page_web.dart';
...
class PhotographerGalleryItemDetailsPageWeb extends StatefulWidget {
  final Map<String, dynamic> item;
  final List<Map<String, dynamic>> allItems;

  const PhotographerGalleryItemDetailsPageWeb({
    super.key,
    required this.item,
  ...
  @override
  State<PhotographerGalleryItemDetailsPageWeb> createState() =>
      _PhotographerGalleryItemDetailsPageWebState();
}

class _PhotographerGalleryItemDetailsPageWebState
    extends State<PhotographerGalleryItemDetailsPageWeb> {
...
Future<void> _openRevisionWorkspace() async {
  final result = await Navigator.push(
    context,
    MaterialPageRoute(
      builder: (_) => PhotographerRevisionWorkspacePageWeb(
        item: currentItem,
                        ...
                        Expanded(
                          ...
                          child: Column(
                            children: [
                              ...
                              _revisionActionsCard(),
                              const SizedBox(height: 14),
                              if (_canShowPortfolioSection) _portfolioSection(),
                            ],
                          ),
                        ),
                      ],
  ...
  Widget _webTopBar(String title) {
    return Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${_versionLabel(currentItem)} • ${_isVideo ? 'Video' : 'Photo'} • Item #$_currentItemId',
                  style: TextStyle(
                    color: _sub,
                    fontFamily: 'Montserrat',
                    fontWeight: FontWeight.w700,
