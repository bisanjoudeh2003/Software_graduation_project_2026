...
class ClientFinalGalleryPageWeb extends StatefulWidget {
  final Map<String, dynamic> gallery;
  final List<Map<String, dynamic>> items;
  final String photographerName;
  final String sessionType;

  const ClientFinalGalleryPageWeb({
    super.key,
  ...
  @override
  State<ClientFinalGalleryPageWeb> createState() => _ClientFinalGalleryPageWebState();
}

class _ClientFinalGalleryPageWebState extends State<ClientFinalGalleryPageWeb> {
        ...
        actions: [
          if (_canDownloadFinalFiles)
            Padding(
              ...
              child: TextButton.icon(
                ...
                label: Text(
                  selecting ? "Cancel Selection" : "Select Files",
                  style: const TextStyle(
                    fontFamily: "Montserrat",
                    color: _green,
                    fontWeight: FontWeight.w900,
          ...
          Padding(
            ...
            child: ElevatedButton.icon(
              onPressed:
                  creatingShareLink || downloadingSelected || _needsRemainingPayment
                      ? null
                      : _showShareDialog,
              style: ElevatedButton.styleFrom(
                backgroundColor: _green,
        ...
        child: ConstrainedBox(
          ...
          child: CustomScrollView(
            slivers: [
                    ...
                    builder: (context, constraints) {
                      ...
                      final cards = [
                        ...
                        _statCard(
                          ...
                          color:
                              _canDownloadFinalFiles ? _gold : Colors.grey,
                        ),
                      ];
              ...
              if (_canRequestCleanCopy ||
                  (_previewWatermarked && _cleanCopyStatus == "pending"))
                SliverToBoxAdapter(
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(24, 0, 24, 18),
                    ...
                    builder: (context, constraints) {
                      ...
                      return SliverGrid(
                        ...
                        gridDelegate:
                          ...
                          crossAxisSpacing: 14,
                          mainAxisSpacing: 14,
                          childAspectRatio: crossAxisCount >= 4 ? 0.76 : 0.70,
                        ),
                      );
                    },
                  ),
