...
import 'plan_full_session_review_page_web.dart';

class PlanFullSessionResultsPageWeb extends StatefulWidget {
  final DateTime selectedDate;
  final TimeOfDay selectedTime;
  final double durationHours;
  final String sessionType;

  const PlanFullSessionResultsPageWeb({
    super.key,
  ...
  @override
  State<PlanFullSessionResultsPageWeb> createState() =>
      _PlanFullSessionResultsPageWebWebState();
}

class _PlanFullSessionResultsPageWebWebState
    extends State<PlanFullSessionResultsPageWeb> {
  bool _loading = true;
...
void _continueNext() {
  ...
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (_) => PlanFullSessionReviewPageWeb(
