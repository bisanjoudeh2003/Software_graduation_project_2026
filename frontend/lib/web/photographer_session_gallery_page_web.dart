...
import 'photographer_gallery_item_details_page_web.dart';
import 'photographer_gallery_setup_page_web.dart';
...
class PhotographerSessionGalleryPageWeb extends StatefulWidget {
  final int bookingId;
  final String clientName;
  final String sessionType;
  final String sessionDate;

  const PhotographerSessionGalleryPageWeb({
    super.key,
  ...
  @override
  State<PhotographerSessionGalleryPageWeb> createState() =>
      _PhotographerSessionGalleryPageWebState();
}

class _PhotographerSessionGalleryPageWebState
    extends State<PhotographerSessionGalleryPageWeb> {
  bool loading = true;
  ...
  Future<void> _openSetupPage({required bool editMode}) async {
    final result = await Navigator.push<Map<String, dynamic>>(
      context,
      MaterialPageRoute(
        builder: (_) => PhotographerGallerySetupPageWeb(
  ...
  void _openDetails(Map<String, dynamic> item) async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => PhotographerGalleryItemDetailsPageWeb(
          item: item,
          allItems: items,
        ),
      ),
                        ...
                        if (!isWide) {
                          return Column(
                            ...
                            children: [
                              ...
                              _galleryGridSection(isWide: false),
                            ],
                          );
                        }
                            ...
                            Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 22),
                                  _galleryGridSection(isWide: true),
                                ],
                              ),
                            ),
  ...
  Widget _webTopBar() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(_isDark ? 0.03 : 0.05),
            blurRadius: 18,
        ...
        children: [
          InkWell(
            ...
            child: Container(
              ...
              child: const Icon(Icons.arrow_back_ios_new_rounded, color: _primaryGreen, size: 18),
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${widget.clientName} • ${widget.sessionType} • ${widget.sessionDate}',
                  maxLines: 1,
          ...
          if (_hasGallery && !_isArchived)
            OutlinedButton.icon(
              ...
              style: OutlinedButton.styleFrom(
                ...
                side: BorderSide(color: _primaryGreen.withOpacity(.25)),
  ...
  Widget _galleryGridSection({required bool isWide}) {
          ...
          if (_visibleItems.isEmpty)
            ...
            GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                mainAxisSpacing: 14,
                crossAxisSpacing: 14,
                childAspectRatio: isWide ? 0.76 : 0.88,
              ),
