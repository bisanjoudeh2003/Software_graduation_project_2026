...
class RemainingBalancePaymentPageWeb extends StatefulWidget {
  final Map<String, dynamic> gallery;
  final String photographerName;
  final String sessionType;

  const RemainingBalancePaymentPageWeb({
    super.key,
  ...
  @override
  State<RemainingBalancePaymentPageWeb> createState() =>
      _RemainingBalancePaymentPageWebState();
}

class _RemainingBalancePaymentPageWebState
    extends State<RemainingBalancePaymentPageWeb> {
