...
class PhotographerDepositPaymentPage extends StatefulWidget {
  final Map booking;

  const PhotographerDepositPaymentPage({super.key, required this.booking});

  @override
  State<PhotographerDepositPaymentPage> createState() =>
      _PhotographerDepositPaymentPageState();
}

class _PhotographerDepositPaymentPageState
    extends State<PhotographerDepositPaymentPage> {
