...
import 'package:url_launcher/url_launcher.dart';        // ← ضيفها للـ pubspec
...
class _OwnerPublicProfilePageState extends State<OwnerPublicProfilePage> {
  ...
  Future loadOwnerVenues() async {
    try {
      final all = await VenueService.getAllVenues();
      setState(() {
        venues  = all.where((v) =>
            v["owner_id"]?.toString() == widget.ownerId.toString()).toList();
        loading = false;
      });
    } catch (e) {
        ...
        slivers: [
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: widget.ownerImage != null &&
                              ...
                              ? Image.network(widget.ownerImage!,
                                  fit: BoxFit.cover,
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Row(
                children: [
                  Expanded(child: _statCard("${venues.length}", "Venues",
                      Icons.location_on_rounded, primaryGreen)),
                  const SizedBox(width: 14),
                  Expanded(child: _statCard(ratingStr, "Avg Rating",
          ...
          // ── BIO ── ✅ جديد
          if (ownerBio != null && ownerBio!.isNotEmpty)
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.fromLTRB(20, 20, 20, 0),
                child: Container(
