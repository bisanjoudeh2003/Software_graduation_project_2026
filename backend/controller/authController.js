...
exports.login = async (req, res) => {
  try {
    ...
    /*
      مهم:
      لا نمنع الحساب المعطل من تسجيل الدخول هنا.
      نخليه ياخذ token عادي، وبعدها Flutter يقرأ status من getMe
      ويفتح AccountDeactivatedScreen بدل صفحات الرول.
    */
  ...
  try {
    const [rows] = await pool.query(
      ...
      SELECT
        ...
        COALESCE(client_flagged, 0) AS client_flagged,
        client_flag_reason,
